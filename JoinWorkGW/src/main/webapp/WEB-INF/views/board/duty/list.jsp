                ...
                <div class="col-12" style="margin-top: 2%; font-family: S-CoreDream-6Bold">
                    ...
                    <c:choose>
                    	<c:when test="${empty param.dutyType }">
	                    	<i class="fa fa-navicon"></i>&nbsp;업무 목록
                    	</c:when>
                    	<c:otherwise>
                    		<c:if test="${param.dutyType eq 'receive' }">
                    			<i class="icon-envelope-letter"></i>&nbsp;받은 업무목록
                    		</c:if>
                        ...
                        <form:form commandName="boardFormVO" id="listForm" name="listForm">
                        	...
                        	<div>
	                        	...
	                        	<div id="navbar-search" class="navbar-form search-form selectSearch" style="float:left;">
	                        		<form:input path="searchDutyVO.searchKeyword" class="form-control" placeholder="검색어 입력" type="text" style="width: 500px;height:36px;padding-right: 40px;" onkeypress="checkEnter(searchDutyList);"/>
