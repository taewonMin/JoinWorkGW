...
<head>
	...
	<%-- <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/templates/assets/vendor/toastr/toastr.min.css"> --%>
	...
	<style>
		...
		.btn-primary, .btn-primary:focus { color: #fff; background-color: #2980b9; border-color: #2980b9; }
		.btn-primary:hover{ background-color: rgb(54 159 223); border-color: rgb(54 159 223); box-shadow: 0 0 0 0px; }
		.btn.focus, .btn:focus{ box-shadow: 0 0 0 0px; }
	</style>
</head>