        ...
        <div class="col-lg-12 whole">
            <div class="card">
                <div class="header">
                    ...
                    <input type="button" onclick="javascript:window.close();" class="btn btn-secondary float-right" value="닫기">
                    <input type="button" onclick="regist();" class="btn btn-primary float-right" id="realRegistBtn" value="저장">
                </div>
                <br>
                <hr/>
	                ...
	                <form id="basic-form" class="horizontal" method="post">
                         <div class="form-group row">
                             ...
                             <div class="col-sm-10 input-group input-group-sm ">
	                             <input type="text" name="codeId" class="form-control" value="${newId }" required="true" readonly="true">
                             </div>
                         </div>
                         <div class="form-group row">
                             <label class="col-sm-2 float-left" style="margin-top: 10px;" for="codeName" >직책명</label>
                             <div class="col-sm-10 input-group input-group-sm">
	                             <input type="text" name="codeName" class="form-control float-left" required="true" autocomplete="off" >
...
function regist(){
	...
	$.ajax({
		url: "<%=request.getContextPath()%>/admin/official/regist"
		,type: "post"
        ,data: registData
